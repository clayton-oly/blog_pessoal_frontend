        ...
        <Grid alignItems="center" item xs={12}>
            <Box className='box1'>
                ...
                <Box display="flex" alignItems="center" justifyContent="center">
                    <a href="https://www.facebook.com/clayton.oly/" target="_blank" rel="noopener noreferrer">
                        <FacebookIcon className='redes'/>
                    </a>
                    <a href="https://www.instagram.com/clayton.oly/" target="_blank" rel="noopener noreferrer">
